...
export class SerieService {
  ...
  constructor() {
    ...
    this.datalist.push(
      ...
      new Review(1, new Date('28-12-2021'), 'GerardDeBrives', "Je préfère Henry Cavill en Sorceleur plutôt qu'en héros à collant!"),
      new Review(2, new Date('15-05-2013'), 'TotoDu38', "Sombre, violent, et trash, la série se perd dans l'histoire et les fesses des courtisanes au fil des saisons. Tant mieux ou dommage selon le point de vue de chacun."),
      new Review(3, new Date('30-08-2017'), 'BouffiContreLesTapirs', 'Moi qui ai joué aux divers jeux de la licence, je ne suis pas déçu. Animation sublime, histoire superbe, je recommande !'),
      new Review(4, new Date('05-06-2019'), 'Brie-Tiche', 'Une mini-série très sympa à regarder avec une tasse de thé Lipton goût pêche'),
      new Review(5, new Date('25-11-2018'), 'Jean-Neige', 'Tout simplement la meilleur série de ces 10 dernières années, même si certains ne vont pas aimer la fin.'),
